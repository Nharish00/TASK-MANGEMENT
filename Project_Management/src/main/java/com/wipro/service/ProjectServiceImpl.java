...
public class ProjectServiceImpl implements ProjectService {
	...
	public ProjectDto updateProjectById(Long x, ProjectDto projectdto) throws ProjectIdNotFoundException {
		Project retrievedUser = repository.findById(x)
				.orElseThrow(() -> new ProjectIdNotFoundException("Project not found with id: " + x));
	...
	public List<APIResponseDto> getProjectById(Long pid) throws ProjectIdNotFoundException {
		Project savedProject = repository.findById(pid)
				.orElseThrow(() -> new ProjectIdNotFoundException("Project not found with id: " + pid));
